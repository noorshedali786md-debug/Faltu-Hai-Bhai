...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/ET_Karva")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ Help", url="https://t.me/ET_Karva")]
    ]
)
...
async def start(bot: Client, m: Message):
    try:
        if m.chat.type == "channel":
            ...
            if not is_authorized:
                await m.reply_photo(
                    photo=photologo,
                    caption="**Mʏ Nᴀᴍᴇ [ Ecourse Trusted DRM 🦋](https://t.me/Ecourse_Trusted)\n\nYᴏᴜ ᴅᴏɴ'ᴛ ʜᴀᴠᴇ ᴀᴄᴄᴇꜱꜱ ᴛᴏ ᴜꜱᴇ ᴛʜɪꜱ ʙᴏᴛ\nCᴏɴᴛᴀᴄᴛ [⌯ FʀᴏɴᴛMᴀɴ | ×͜× |](https://t.me/ET_Karva) ғᴏʀ ᴀᴄᴄᴇꜱꜱ**",
                    reply_markup=InlineKeyboardMarkup([
    [
        InlineKeyboardButton("⌯ FʀᴏɴᴛMᴀɴ | ×͜× |", url="https://t.me/ET_Karva")
    ],
    [
        InlineKeyboardButton("ғᴇᴀᴛᴜʀᴇꜱ 🪔", callback_data="https://t.me/ET_Karva"),
        InlineKeyboardButton(" Official Channel 🦋", url="https://t.me/+eC5BHJojTIY0ZmNl")
    ]
])
                )
                return
    ...
    [
        InlineKeyboardButton("ғᴇᴀᴛᴜʀᴇꜱ 🪔", callback_data="https://t.me/ET_Karva"),
        InlineKeyboardButton("ᴅᴇᴛᴀɪʟꜱ 🦋", url="https://t.me/+eC5BHJojTIY0ZmNl")
    ]])
)
...
async def unauthorized_handler(client, message: Message):
    await message.reply(
        ...
        reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton("💫 Get Premium Access", url="https://t.me/ET_Karva")
        ]])
    )
